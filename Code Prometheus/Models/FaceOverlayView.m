...
- (void)drawCircleWithPoints:(CGPoint *)points pointCount:(NSUInteger)pointCount
{
    ...
    /* Drawing outline. */
    [self renderLinesWithPoints:points pointCount:pointCount strokeColor:self.strokeColor lineWidth:[self glWidthForWindowWidth:self.lineWidth] looped:YES];
}
...
- (void)drawLineWithPoints:(CGPoint *)points pointCount:(NSUInteger)pointCount
{
    ...
    /* Drawing line. */
    [self renderLinesWithPoints:points pointCount:pointCount strokeColor:self.strokeColor lineWidth:[self glWidthForWindowWidth:self.lineWidth] looped:NO];
}
